  ...
  experienceInfo: [
    {
      ...
      endDate: "present",
      location: "New York City, US",
      description: `Designed and prototyped user interface patterns for various clients in various industries,
...

    {
      ...
      description: `Supported senior researchers on accessibility standards for the open web. 
      Created and usability tested wireframes and prototypes. 
      Produced interactive documentation for quick onboarding of new researchers.`,
    },
  ],
};

export { originalPersonInfoData };
